                                                    ...
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div
                                                            ...
                                                            <p style="font-size: 14px; line-height: 140%;">
                                                                <strong>YOU ARE INVITED TO Sign up for Jeeves-assignment-app</strong></p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                        ...
                                                        <div
                                                            ...
                                                            <p style="font-size: 14px; line-height: 160%;"><span
                                                                    style="font-size: 18px; line-height: 28.8px;">You've
                                                                    been invited to join a Jeeves-assignment-app.
                                                                    Click the link to finish setting up and access
                                                                    free account.</span></p>
                                                        </div>
                                                    </td>
                                                </tr>
...
export { getHtml as getInviteEmailHtml }